 ...
 *   node jira-api.js create --project ACME --summary "Fix thing" --type Bug
 *   node jira-api.js search --jql 'project = ACME AND statusCategory != Done'
 *   node jira-api.js bulk-update --jql 'project = ACME AND labels = stale' --labels ''
 */
...
Examples:
  bulk-update --jql 'project = ACME AND labels = stale' --labels ''
  bulk-update --jql 'project = ACME AND priority = Lowest' --priority Low --apply
`);
}
