...
```
Matched 3 issue(s):
  CD-1234   Connection pool leak in auth service
  CD-1240   Add timeout to HTTP client calls
  CD-1255   Retry login on transient 5xx
...
```
✅ CD-1234 updated
❌ CD-1240 failed: no transition to "Done" available from current state
✅ CD-1255 updated
