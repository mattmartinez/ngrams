...
2. **What works**: a short bullet list of changes that improved val_bpb.
3. **What doesn't work**: a short bullet list of changes that hurt or had no effect.
...
- **Make a structural change.** Change the model architecture itself: different attention mechanism, normalization, positional encoding, adding/removing layers, changing the optimizer algorithm, etc.
...
**Experiment categories** (maintain diversity across these):
...
- Compounding untested changes together is dangerous
